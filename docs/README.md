...
| Page | Answers |
| --- | --- |
| [requirements.md](requirements.md) | What has to be installed first? |
| [installation.md](installation.md) | How do I add this to my plugin manager? |
...
| [CONTRIBUTING.md](CONTRIBUTING.md) | How do I run the tests / add a format? |
